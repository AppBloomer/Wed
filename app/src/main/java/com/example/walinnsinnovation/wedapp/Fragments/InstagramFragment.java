...
public class InstagramFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener, DownloadListener, View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view;
        view = inflater.inflate(R.layout.insta_layout, container, false);

        this.f4451b =(View)view.findViewById(R.id.InstagramBackgroundView);
        this.f4451b.setVisibility(0);
        this.f4452c = (ImageView)view.findViewById(R.id.instagramLogo);
        ...
        this.mWebview = (ObservableWebView) view.findViewById(R.id.InstagramWebView);
        this.mWebview.setWebViewClient(new InstagramFragment.C1320b(InstagramFragment.this));
        this.mWebview.setWebChromeClient(new InstagramFragment.C1317a(InstagramFragment.this));
        WVSettings();
        ...
        if (isNetworkAvailable()) {
            ...
            this.mWebview.loadUrl(getString(R.string.instagram_url));
    ...
    private class C1320b extends WebViewClient {
        final /* synthetic */ InstagramFragment f4449a;

        private C1320b(InstagramFragment InstagramFragment) {
            this.f4449a = InstagramFragment;
        }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("com.instagram.android") || url.contains("play.google")) {
                try {
                    this.f4449a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=com.instagram.android")));
                } catch (ActivityNotFoundException e) {
                    this.f4449a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("http://play.google.com/store/apps/details?id=com.instagram.android")));
                }
    ...
    private class C1317a extends WebChromeClient {
        final /* synthetic */ InstagramFragment f4444a;

        class C13163 implements Runnable {
            final /* synthetic */ InstagramFragment.C1317a f4443a;

            C13163(InstagramFragment.C1317a c1317a) {
                this.f4443a = c1317a;
            }
        ...
        private C1317a(InstagramFragment InstagramFragment) {
            this.f4444a = InstagramFragment;
        }
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (newProgress > 30) {
                ...
                this.f4444a.f4452c.postDelayed(new InstagramFragment.C1317a.C13163(this), 600);
    ...
    public void onStart() {
        ...
        ViewTreeObserver.OnScrollChangedListener c13132 = new InstagramFragment.C13132(this);
        this.f4453d = c13132;
    ...
    class C13132 implements ViewTreeObserver.OnScrollChangedListener {
        final /* synthetic */ InstagramFragment f4436a;

        C13132(InstagramFragment InstagramFragment) {
            this.f4436a = InstagramFragment;
        }
