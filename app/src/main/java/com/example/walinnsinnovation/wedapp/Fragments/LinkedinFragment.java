...
public class LinkedinFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener, DownloadListener, View.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view;
        view = inflater.inflate(R.layout.linkedin_layout, container, false);
        ...
        this.mWebview = (ObservableWebView) view.findViewById(R.id.LnkedWebView);
        this.mWebview.setWebViewClient(new LinkedinFragment.C1320b(LinkedinFragment.this));
        this.mWebview.setWebChromeClient(new LinkedinFragment.C1317a(LinkedinFragment.this));
        WVSettings();
        ...
        if (isNetworkAvailable()) {
            ...
            this.mWebview.loadUrl(getString(R.string.linked_url));
    ...
    private class C1320b extends WebViewClient {
        final /* synthetic */ LinkedinFragment f4449a;

        private C1320b(LinkedinFragment LinkedinFragment) {
            this.f4449a = LinkedinFragment;
        }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("com.linkedin.android") || url.contains("play.google")) {
                try {
                    this.f4449a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=com.linkedin.android")));
                } catch (ActivityNotFoundException e) {
                    this.f4449a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("http://play.google.com/store/apps/details?id=com.linkedin.android")));
                }
            } else if (url.contains("linkedin://timeline")) {
    ...
    private class C1317a extends WebChromeClient {
        final /* synthetic */ LinkedinFragment f4444a;

        class C13163 implements Runnable {
            final /* synthetic */ LinkedinFragment.C1317a f4443a;

            C13163(LinkedinFragment.C1317a c1317a) {
                this.f4443a = c1317a;
            }
        ...
        private C1317a(LinkedinFragment LinkedinFragment) {
            this.f4444a = LinkedinFragment;
        }
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (newProgress > 30) {
                ...
                this.f4444a.f4452c.postDelayed(new LinkedinFragment.C1317a.C13163(this), 600);
    ...
    public void onStart() {
        ...
        ViewTreeObserver.OnScrollChangedListener c13132 = new LinkedinFragment.C13132(this);
        this.f4453d = c13132;
    ...
    class C13132 implements ViewTreeObserver.OnScrollChangedListener {
        final /* synthetic */ LinkedinFragment f4436a;

        C13132(LinkedinFragment LinkedinFragment) {
            this.f4436a = LinkedinFragment;
        }
